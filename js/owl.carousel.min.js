...
$(document).ready(function () {
  $('.service-carousel').owlCarousel({
    ...
    margin: 20,
    nav: true,
    navText: ['<span class="prev-btn">&#10094;</span>', '<span class="next-btn">&#10095;</span>'], // left & right arrows
    dots: false,
    autoplay: true,
...
// $(document).ready(function () {
//   $('.other-service-slider .owl-carousel').owlCarousel({
//     loop: true,
//     margin: 20,
//     nav: true,
//     dots: true,
...
const $carousel = $('.other-service-slider .owl-carousel');
...
$(document).ready(function () {
  const $carousel = $(".servepro .service-carousel");
  ...
  $(".servepro .prev-btn").click(function () {
    $carousel.trigger('prev.owl.carousel');
  });

  $(".servepro .next-btn").click(function () {
